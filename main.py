...
def messageHandler(update: Update, context: CallbackContext):
    ...
    if "order status" in update.message.text:
        ...
        cursor.execute(f'select top 1 status  from bot2 ;'
                        )
    ...
    def queryHandler(update: Update, context: CallbackContext):
        ...
        # elif "aceepted" in query:
        #     context.bot.send_message(
        #         chat_id=update.effective_chat.id, text="successfully accepted!")

        #     order_status2 = "a"
        #     print("create")
        #     cursor = connection.cursor()
        #     cursor.execute('update bot2 set status=?;',
        #                    (order_status2))
        #     connection.commit()

        # elif "decline" in query:
        #     context.bot.send_message(
        #         chat_id=update.effective_chat.id, text="you rejected order:(")
        #     order_status = "sorry, your order refused"
        print(
